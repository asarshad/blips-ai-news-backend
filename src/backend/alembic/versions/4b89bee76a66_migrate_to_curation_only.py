...
def upgrade() -> None:
    ...
    if 'conversations' in inspector.get_table_names():
        ...
        if 'article_id' in columns:
            ...
            if any(fk['name'] == 'conversations_article_id_fkey' for fk in fks):
                op.drop_constraint('conversations_article_id_fkey', 'conversations', type_='foreignkey')
            ...
            op.create_foreign_key('conversations_content_item_id_fkey', 'conversations', 'content_items', ['content_item_id'], ['id'])
    ...
    if 'usage' in inspector.get_table_names():
        ...
        if 'article_id' in columns:
            ...
            # Add new foreign key to content_items
            op.create_foreign_key('usage_content_item_id_fkey', 'usage', 'content_items', ['content_item_id'], ['id'])
