...
class TestScoringService:
    ...
    def test_compute_quality_score(self, mock_content_repo, mock_event_repo, sample_content_item):
    ...
    def test_compute_recency_score_fresh(
        self, mock_content_repo, mock_event_repo, sample_content_item
    ):
...
class TestClusteringService:
    ...
    def test_entity_overlap(self, mock_content_repo):
    ...
    def test_title_similarity(self, mock_content_repo):
    ...
    def test_compute_similarity(self, mock_content_repo):
    ...
    def test_no_clustering_for_dissimilar_content(self, mock_content_repo):
    ...
    def test_no_clustering_for_same_entity_different_context(self, mock_content_repo):
...
class TestPersonalizationService:
    ...
    def test_record_interaction(
        ...
        event = service.record_interaction(
            device_id="test-device", content_item_id=1, event_type=EventType.VIEW_10S
        )
    ...
    def test_compute_personalization_score_new_user(
        ...
        score = service.compute_personalization_score(
            device_id="new-user", content=sample_content_item
        )
    ...
    def test_preference_decay_reduces_weight(
        self, mock_profile_repo, mock_preference_repo, mock_event_repo, mock_content_repo
    ):
...
class TestPlaylistService:
    ...
    def test_check_topic_diversity_empty(
        ...
        item = ContentItem(
            id=1, type=ContentType.ARTICLE, title="Test", source="Test", topics=["ai", "tech"]
        )
    ...
    def test_check_source_rotation_allowed(
        ...
        item = ContentItem(id=1, type=ContentType.ARTICLE, title="Test", source="Source1")
    ...
    def test_format_item(
        self, mock_content_repo, mock_profile_repo, mock_preference_repo, sample_content_item
    ):
