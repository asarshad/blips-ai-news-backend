...
def _to_summary(item) -> ContentItemSummary:
    return ContentItemSummary(
        ...
        tech_relevance=item.tech_relevance,
        tech_relevance_confidence=item.tech_relevance_confidence,
        tech_relevance_reason=item.tech_relevance_reason,
    )
...
def list_content(
    ...
    readiness_status: Optional[str] = Query(None, description="READY|PENDING"),
