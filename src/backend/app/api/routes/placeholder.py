...
Returns a deterministic PNG rendered from the ``source`` and optional
...
from app.services.article_image_placeholder import render_source_placeholder_png
...
def get_source_placeholder(
    ...
    png_body = render_source_placeholder_png(
        source=source,
        category=category,
        width=width,
        height=height,
