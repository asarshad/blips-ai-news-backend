...
FEED_REGISTRY: List[FeedConfig] = [
    ...
    FeedConfig(
        ...
        daily_cap=3,
        decay_profile=DecayProfile.NORMAL,
        base_quality_weight=0.72,
        notes="Software architecture, enterprise patterns — demoted from PREMIUM: covers too many niche language/framework topics (Prolog, Clojure, dbt) that don't serve a broad tech-news audience",
    ),
    FeedConfig(
